...
public class UndirectedWeightedGraphBuilder extends GraphBuilder {
	private WeightedPseudograph<Vertex, LabeledEdge> g;
	 ...
	 */
	public UndirectedWeightedGraphBuilder(String filename) throws FileNotFoundException {
		super(filename);
		g = new WeightedPseudograph<Vertex,LabeledEdge>(LabeledEdge.class);
			...
			while ((currentLine = this.bReader.readLine()) != null) {
				if (!currentLine.equals("")) {
					...
					g.addEdge(s, t, new LabeledEdge(s, t, null, 0.0));
						...
						g.addVertex(s);
						g.addVertex(t);
						g.addEdge(s, t, new LabeledEdge(s, t, null, Double.parseDouble(vertices[3])));				
					}
				}
			}
			this.bReader.close();
